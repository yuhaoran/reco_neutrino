...
P3DFFT_LIB=/HOME/bnu_ztj_1/SYS/fftw215/lib
P3DFFT_INC=/HOME/bnu_ztj_1/SYS/fftw215/include
...
mpif90 -shared-intel -fpp -g -O3 -xhost -openmp -i_dynamic -mcmodel=medium  dist_init_dmnu.f90 -DZIP -DSLAB -I$P3DFFT_INC -o dist_init_dmnu_dm -L$P3DFFT_LIB -lsrfftw_mpi -lsrfftw -lsfftw_mpi -lsfftw -lm -ldl
...
mpif90 -shared-intel -fpp -g -O3 -xhost -openmp -i_dynamic -mcmodel=medium       -DZIP -DSLAB   -DNEUTRINOS -DVELTRANSFER  dist_init_dmnu.f90 -I$P3DFFT_INC -I$MKL_FFTW_INC -o dist_init_dmnu_nu -L$P3DFFT_LIB -lsrfftw_mpi -lsrfftw -lsfftw_mpi -lsfftw -lm -ldl
echo
echo "done"
echo
