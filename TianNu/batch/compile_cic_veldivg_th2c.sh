...
mpif90 -shared-intel -fpp -g -O3 -openmp -mkl -mcmodel=medium -DZIP -DZIPDM -DNGP -DLOGBIN -Dwrite_velxxx -DMOMENTUM -DCOARSE_HACK -DTH2 indexedsort.f90 cic_veldivg_dmnu.f90 -I$P3DFFT_INC -I$MKL_FFTW_INC -o ngp_veldivg -L$MKL_FFTW_LIB -L$P3DFFT_LIB -lp3dfft -lmkl_intel_lp64
